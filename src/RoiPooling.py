...
class RoiPooling(keras.layers.Layer):
  ...
  def compute_output_shape(self, input_shape):
    return [self.num_rois, self.pool_size, self.pool_size, self.n_channels]
  ...
  def call(self, x, mask=None):
    ...
    final_output = tf.reshape(final_output, (self.num_rois, self.pool_size, self.pool_size, self.n_channels))
